...
if('function' === typeof importScripts) {
  ...
  let local = self.location.origin && self.location.origin.indexOf("localhost") != -1;
  if (local) {
    importScripts(
      "./demuxer_mp4.js",
      "./renderer_2d.js"
    ...
    importScripts(
      "https://cdn.jsdelivr.net/gh/369-jas/srcdn@main/22/demuxer_mp4.js",
      "https://cdn.jsdelivr.net/gh/369-jas/srcdn@main/22/renderer_2d.js"
    );
  }
